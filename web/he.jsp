...
<html>
    ...
    <body>
        ...
        if(req.equals("out")){
        String sql="SELECT * FROM healthcenter where id="+request.getParameter("id");
    ...
    <% 
            ...
            PreparedStatement psmnt=connection.prepareStatement("update healthcenter set "+'"'+"name"+'"'+"=?, address=? ,phone=?, patients=? ,longitude=?, latitude=? where ID=" + request.getParameter("id") );
