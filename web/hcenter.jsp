...
<html>
    <head>
       ...
       <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.10.2/css/all.css">
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAQSIsLoSKjSeI8er10xAaVcOlQfWJdl6o"></script>
    </head>
    <body>
        <div class="topnav">
          <a href="index.jsp">HOME</a>
          <a href="cases.jsp">Positive Cases Distribution</a>
          <a class="active" href="">Health Centers</a>
        ...
        <div>
             ...
             <TABLE  id="tn"  class="table table-bordered table-dark">
            <thead>
                <td>ID</td>
        ...
        String sql="SELECT * FROM HEALTHCENTER";
        ...
        %>
            <tr onclick="changeMAP(this)">
                ...
                <td >  <form method="post" action="he.jsp"  id="editcol2">
                 <input type="number" name="id" value="<%=resultSet.getInt("id") %>" hidden/>
        ...
        if(ut==null){
            out.println("<script>"
                    ...
                    + "document.getElementById('up').removeAttribute('hidden');"
                        + "document.getElementById('editcol').setAttribute('hidden',true);"
                    + "document.getElementsByClassName('editcol2').setAttribute('hidden',true);"
            ...
            out.println("<script>"
                    ...
                    + "document.getElementById('editcol').removeAttribute('hidden');"
                     + "document.getElementsByClassName('editcol2').removeAttribute('hidden');"
