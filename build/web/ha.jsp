...
<html>
    <head>
        ...
        <title>Add new Health Center</title>
        <style type="text/css">
    ...
    <form method="post" action="">
		...
		<div class="form-group">
            <input type="text" class="form-control" name="patients" placeholder="patients" required="required">
                                       ...
                                       <div class="row">
                                          <div class="col-xs-6">	
                                              <input type="text" id="lat" class="form-control" name="longitude" placeholder="longitude" required="required"></div>
                ...
                if(name!=null){
                    ...
                    String latitude=request.getParameter("latitude");
                        try{ 
                            ...
                            String sql = "insert into healthcenter(";
                            sql = sql + '"'+"name"+'"';
